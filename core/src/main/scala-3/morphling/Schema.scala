...
object Schema {
  ...
  /** The type of free applicative values which are used to capture the structure
    ...
    * @tparam I $IDefn
    */
  type Prop[P[_], O, I] = FreeApplicative[PropSchema[O, Schema[P, _], _], I]

  given [P[_], O]: Applicative[Prop[P, O, _]] =
    FreeApplicative.freeApplicative[PropSchema[O, Schema[P, _], _]]

  given [P[_]]: Profunctor[[Y, Z] =>> Prop[P, Y, Z]] =
    new Profunctor[[Y, Z] =>> Prop[P, Y, Z]] {
      override def dimap[O, I, N, J](prop: Prop[P, O, I])(f: N => O)(g: I => J): Prop[P, N, J] =
        prop.compile[PropSchema[N, Schema[P, _], _]](
          PropSchema.contraNT[O, N, Schema[P, _]](f)
        ).map(g)
    }
  ...
  /** Lifts a SchemaF value into an unannotated Schema
    ...
    */
  def schema[P[_], I](sf: => SchemaF[P, Schema[P, _], I]): Schema[P, I] =
    hfix[[Y[_], Z] =>> SchemaF[P, Y, Z], I](sf)
  ...
  def prim[P[_], I](p: P[I]): Schema[P, I] =
    schema(PrimSchema[P, Schema[P, _], I](p))
  ...
  def rec[P[_], I](props: Props[P, I]): Schema[P, I] =
    schema(RecordSchema[P, Schema[P, _], I](props))
  ...
  def required[P[_], O, I](fieldName: String, valueSchema: Schema[P, I], extract: Extract[O, I]): Prop[P, O, I] = {
    FreeApplicative.lift[PropSchema[O, Schema[P, _], _], I](
      Required[O, Schema[P, _], I](fieldName, valueSchema, extract, None)
    )
  }
  ...
  def property[P[_], O, I](fieldName: String, valueSchema: Schema[P, I], default: I, extract: Extract[O, I]): Prop[P, O, I] = {
    FreeApplicative.lift[PropSchema[O, Schema[P, _], _], I](
      Required[O, Schema[P, _], I](fieldName, valueSchema, extract, Some(default))
    )
  }
  ...
  def optional[P[_], O, I, OI <: Option[I]](fieldName: String, valueSchema: Schema[P, I], extract: Extract[O, OI]): Prop[P, O, Option[I]] = {
    FreeApplicative.lift[PropSchema[O, Schema[P, _], _], Option[I]](
      Optional[O, Schema[P, _], I](fieldName, valueSchema, extract.asInstanceOf[Extract[O, Option[I]]])
    )
  }
  ...
  final class AbsentBuilder[P[_]] {
    def apply[O, I, OI <: Option[I]](fieldName: String, extract: Extract[O, OI]): Prop[P, O, Option[I]] = {
      FreeApplicative.lift[PropSchema[O, Schema[P, _], _], Option[I]](
        Absent[O, Schema[P, _], I](fieldName, extract.asInstanceOf[Extract[O, Option[I]]])
      )
    }
  ...
  def const[P[_], O](obj: O): Schema[P, O] =
    rec[P, O](FreeApplicative.pure[PropSchema[O, Schema[P, _], _], O](obj))

  /*

    Need to re-implement Constructors first
  ...
  */
  ...
  /** Builds an un-annotated schema for the sum type `I` from a list of alternatives.
    ...
    * @tparam I $IDefn
    */
  def unsafeOneOf[P[_], I](alts: NonEmptyList[Alt[Schema[P, _], I, ?]]): Schema[P, I] =
    schema(OneOfSchema[P, Schema[P, _], I](alts))

  def unsafeOneOfDiscr[P[_], I](discriminatorField: String)(alts: NonEmptyList[Alt[Schema[P, _], I, ?]]): Schema[P, I] =
    schema(OneOfSchema[P, Schema[P, _], I](alts, Some(discriminatorField)))
  ...
  /** Convenience constructor for oneOf schema alternatives.
    ...
    */
  def alt[P[_], I, J](id: String, base: Schema[P, J], subset: Subset[I, J]): Alt[Schema[P, _], I, J] =
    Alt[Schema[P, _], I, J](id, base, subset)

  /** HAlgebra for primitive type constructor transformation.
    */
  def hfmapAlg[P[_], Q[_]](nt: P ~> Q): SchemaF[P, Schema[Q, _], _] ~> Schema[Q, _] =
    new HAlgebra[[Y[_], Z] =>> SchemaF[P, Y, Z], Schema[Q, _]] {
      def apply[I](s: SchemaF[P, Schema[Q, _], I]): Schema[Q, I] = hfix(s.pmap(nt))
    }

  given HFunctor[Schema] = new HFunctor[Schema] {
    def hlift[P[_], Q[_]](nt: P ~> Q): Schema[P, _] ~> Schema[Q, _] = cataNT(hfmapAlg(nt))
  }

  extension [P[_], I](base: Schema[P, I]) {
    def composeIso[J](eqv: Equivalent[I, J]): Schema[P, J] = {
      schema(IsoSchema[P, Schema[P, _], I, J](base, eqv))
    }
  }
}